  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Átilla e Marrocos</a>
        </div>
      </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="editar.php?idUp=<?php echo $show->id_contato; ?>" title="Editar" class="btn btn-success"><img style="width: 15px;" src="img/svg/editar.png"></a>
                    <a href="deletar.php?idDel=<?php echo $show->id_contato; ?>" onclick="return confirm('Tem certeza que deseja remover <?php echo $show->nome_contato; ?>?')" title="Remover" class="btn btn-danger"><img style="width: 15px;" src="img/svg/remover.png"></a></td>
                     </tr>
                  <?php
                      }
                    }else{
