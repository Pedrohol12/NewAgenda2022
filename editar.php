             ...
             ?>
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  <button name="btnUpContato" type="submit" class="btn btn-primary">Cadastrar Contato</button>
                </div>
              </form>
              <?php
                  include_once('config/conexao.php');
          ...
          <div class="col-md-25">
            <div class="card card-primary">
              ...
              <div class="card-body p-15" style="text-align:center">
               <img style="width:164px; border-radius:100%;margin-top:75px" src="img/contato/622b2ac876bd6.jpeg">
               <h1>Pedro Átilla</h1>
               <h2>(85)99220-7402</h2>
               <h2>pedroaholanda333@gmail.com</h2>
